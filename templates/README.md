# Docusaurus Templates for cargo-doc-docusaurus

This directory contains the necessary files to integrate Rust documentation generated by `cargo-doc-docusaurus` into a Docusaurus site.

**Note:** All templates are embedded in the `cargo-doc-docusaurus` binary. You don't need to manually copy these files. Use `cargo doc-docusaurus components init <path>` to install them automatically.
...
│   └── README.md              # Component documentation
├── RustDocSidebar/
│   ├── index.tsx.txt          # React component for documentation sidebar
│   └── README.md              # Component documentation
├── DocSidebarItem/
│   └── Link/
...
- Install all 9 component files
- Skip files that already exist (no overwrites)
- Show post-installation instructions

### Get CSS Variables

To customize colors in your `custom.css`:
...
If you need to customize components before installation:
